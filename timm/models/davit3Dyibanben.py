...
def window_partition(x, window_size):
    ...
    x = x.reshape(B,D // window_size[0], window_size[0], H // window_size[1], window_size[1],W // window_size[2], window_size[2], C)
...
class DaViT(nn.Module):
    ...
    def __init__(self, in_chans=256, num_classes=5, depths=(2, 2, 6, 2), patch_size=(4,4,4),
                 embed_dims=(96, 192, 384, 768), num_heads=(2, 4, 8, 16), window_size=(1,2,2), mlp_ratio=4.,
