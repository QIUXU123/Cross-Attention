...
def window_partition(x, window_size):
    ...
    if D // window_size[0]!=0 and H // window_size[1]!=0 and W // window_size[2]!=0:
        ...
        print(2)
        x = x.view(B, 1, window_size[0], H // window_size[1], window_size[1], W // window_size[2], window_size[2], C)
    elif D // window_size[0]==0 and H // window_size[1]==0 and W // window_size[2]==0:
        print(3)
        x = x.view(B, 1, window_size[0], 1,window_size[1], 1, window_size[2], C)
    print(x.shape)
    windows = x.permute(0, 1, 3, 5, 2, 4, 6, 7).contiguous().view(B, reduce(mul, window_size), C)
    return windows
