...
class SwinTransformer3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.cross_attention = nn.ModuleList(
            [CrossAttentionLayer(fusion_dim, n_heads, pf_dim, audiodrop,embed_dim,fusionLayer,audio_lenth,audio_dim)for _ in range(audio_representation_layers)] )
#         self.cross_attention = nn.ModuleList(
#             [CrossAttentionLayer(hid_dim, n_heads, pf_dim, dropout) for _ in range(cross_attention_layers)])
        ...
        self.custom_layer_1 = nn.Linear(self.num_features*item, custom_layer_1outdim)
