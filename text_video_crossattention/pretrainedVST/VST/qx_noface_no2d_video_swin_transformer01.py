...
class SwinTransformer3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.custom_layer_1 = nn.Linear(int(embed_dim * 2**4), custom_layer_1outdim)
    ...
    def forward(self, video):
        ...
        x = rearrange(video,'B C H W T -> B H W T C')
        B,_,_,_,_ = x.shape
...
def swin(*, weights: Optional[Swin3D_B_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer3D:
